...
from transform import transform_rev_src_2
...
def run_pipeline_rev_src_2():
    try:
        ...
        new_data = extract_db_new_updated_rev("rev_source_2")
        # Transforming the new/updated records to clean data
        transformed_data = transform_rev_src_2(new_data)
        ...
        generic_loads.load_db_rev_clean("rev_source_2_clean")
...
if __name__ == "__main__":
    logger.info("Starting ETL Pipeline for revenue source 2...")
    run_pipeline_rev_src_2()
    logger.info("Finished ETL Pipeline for revenue source 2")