...
from transform import transform_rev_src_3
...
def run_pipeline_rev_src_3():
    try:
        ...
        new_data = extract_db_new_updated_rev("rev_source_3")
        # Transforming the new/updated records to clean data
        transformed_data = transform_rev_src_3(new_data)
        ...
        generic_loads.load_db_rev_clean("rev_source_3_clean")
...
if __name__ == "__main__":
    logger.info("Starting ETL Pipeline for revenue source 3...")
    run_pipeline_rev_src_3()
    logger.info("Finished ETL Pipeline for revenue source 3")